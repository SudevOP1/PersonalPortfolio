  ...
  let skills = {
    ...
    "Databases / Tech": {
      list: [
        ...
        { name: "WebSockets", link: "https://developer.mozilla.org/en-US/docs/Web/API/WebSockets_API" },
        { name: "JWT Authentication", link: "https://jwt.io/" },
        { name: "SQLite", link: "https://www.sqlite.org/" },
        { name: "Google Books API", link: "https://developers.google.com/books" },
        { name: "ImgFlip API", link: "https://imgflip.com/api" },
      ],
    ...
    Tools: {
      list: [
        ...
        { name: "AutoCAD", link: "https://www.autodesk.com/products/autocad/" },
      ],
